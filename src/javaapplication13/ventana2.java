...
public class ventana2 extends javax.swing.JFrame {
    ...
    public void infoUsuarios(){
        ...
        for(int i=0;i<usuarios.length;i++){
            if(usuarios[i]!=null){
                ...
                matriz[i][0] = String.valueOf(usuarios[i].getCarnet());
    ...
    private void initComponents() {
        ...
        TablaUsuarios.setMinimumSize(new java.awt.Dimension(45, 16));
        TablaUsuarios.setPreferredSize(new java.awt.Dimension(225, 16));
